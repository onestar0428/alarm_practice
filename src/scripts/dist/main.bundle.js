...
/***/ "./src/scripts/components/alarm-list.js":
/*!**********************************************!*\
  !*** ./src/scripts/components/alarm-list.js ***!
  \**********************************************/
...
/* harmony export */   "default": function() { return /* binding */ AlarmList; }
/* harmony export */ });
...
var AlarmList = /*#__PURE__*/function () {
  function AlarmList(_ref) {
    var $root = _ref.$root,
        onOffClick = _ref.onOffClick,
  ...
  _createClass(AlarmList, [{
    ...
    value: function init() {
      ...
      var titleText = document.createTextNode("알람목록");
    ...
    value: function addAlarm(alarm) {
      ...
      var textNode = document.createTextNode("".concat(alarm.time, " ").concat(alarm.content));
      li.appendChild(textNode);
      var btnSpan = document.createElement("span");
      var offBtn = document.createElement("button");
      var offBtnText = document.createTextNode("끄기");
      offBtn.id = "off";
      ...
      btnSpan.addEventListener("click", function (e) {
        switch (e.target.id) {
          case 'off':
            alarm.mode = "x";
            break;
          ...
          case 'delete':
            _this.list.removeChild(li);

            _this.deleteAlarm(alarm);
    ...
    key: "updateList",
    value: function updateList(time) {
      var _this2 = this;
    ...
    key: "deleteAlarm",
    value: function deleteAlarm(date, time) {
      var newArr = [];
      this.alarmList.forEach(function (alarm) {
        if (alarm.time.split(':')[0] - time.split(':')[0] !== 0 || alarm.time.split(':')[1] - time.split(':')[1] !== 0 || alarm.date.split('.')[0] - date.split('.')[0] !== 0 || alarm.date.split('.')[1] - date.split('.')[1] !== 0 || alarm.date.split('.')[2] - date.split('.')[2] !== 0) {
          newArr.push(alarm);
        }
      });
...
/***/ "./src/scripts/components/alarm-message.js":
/*!*************************************************!*\
  !*** ./src/scripts/components/alarm-message.js ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ AlarmMessage; }
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var AlarmMessage = /*#__PURE__*/function () {
  function AlarmMessage(_ref) {
    var $root = _ref.$root,
        getAlarmList = _ref.getAlarmList,
        deleteAlarm = _ref.deleteAlarm;

    _classCallCheck(this, AlarmMessage);
  ...
  _createClass(AlarmMessage, [{
    key: "init",
    value: function init() {
      var frag = document.createDocumentFragment();
      var title = document.createElement("h2");
      var titleText = document.createTextNode("메시지");
      title.appendChild(titleText);
      frag.appendChild(title);
    ...
    value: function setCheck() {
      ...
      return function (year, month, day, hour, minute) {
        var ringAlarms = _this.getAlarmList().filter(function (alarm) {
          var dateSplit = alarm.date.split('.');
          var timeSplit = alarm.time.split(':');
          var yy = dateSplit[0];
          var mm = dateSplit[1];
          var dd = dateSplit[2];
          var h = timeSplit[0];
          ...
          if (year - yy === 0 && month - mm === 0 && day - dd === 0 && hour - h === 0 && minute - m === 0) {
            return true;
          }
        ...
        _this.addMessage(ringAlarms);

        _this.deleteAlarm("".concat(year, ".").concat(month, ".").concat(day), "".concat(hour, ":").concat(minute));
      };
    }
  }, {
    key: "addMessage",
    value: function addMessage(alarms) {
      this.textArea.value += alarms.reduce(function (acc, curr) {
        return acc + "".concat(curr.time, " ").concat(curr.content, " (").concat(curr.mode, "\uC54C\uB9BC)!\n");
      }, '');
    }
  }]);
...
/* harmony export */ });
/* harmony import */ var _alarm_list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./alarm-list.js */ "./src/scripts/components/alarm-list.js");
/* harmony import */ var _alarm_message_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alarm-message.js */ "./src/scripts/components/alarm-message.js");
/* harmony import */ var _curr_clock_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./curr-clock.js */ "./src/scripts/components/curr-clock.js");
/* harmony import */ var _register_alarm_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./register-alarm.js */ "./src/scripts/components/register-alarm.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init($root) {
      var currClock = new _curr_clock_js__WEBPACK_IMPORTED_MODULE_2__.default({
        $root: $root
      });
      var registerAlarm = new _register_alarm_js__WEBPACK_IMPORTED_MODULE_3__.default({
        $root: $root,
        onAdd: function onAdd(alarm) {
          alarmList.addAlarm(alarm);
        }
      });
      var alarmList = new _alarm_list_js__WEBPACK_IMPORTED_MODULE_0__.default({
        $root: $root
      });
      var alarmMessage = new _alarm_message_js__WEBPACK_IMPORTED_MODULE_1__.default({
        $root: $root,
        getAlarmList: function getAlarmList() {
          return alarmList.getAlarmList();
        },
        deleteAlarm: function deleteAlarm(date, time) {
...
/***/ "./src/scripts/components/curr-clock.js":
/*!**********************************************!*\
  !*** ./src/scripts/components/curr-clock.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ CurrClock; }
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var CurrClock = /*#__PURE__*/function () {
  function CurrClock(_ref) {
    var $root = _ref.$root;

    _classCallCheck(this, CurrClock);

    this.root = $root;
    this.init();
  }

  _createClass(CurrClock, [{
    key: "init",
    value: function init() {
      var frag = document.createDocumentFragment();
      var title = document.createElement("h2");
      var titleText = document.createTextNode("현재 시간");
      title.appendChild(titleText);
      frag.appendChild(title);
    ...
    key: "updateClock",
    value: function updateClock(checkAlarmList) {
      var _this = this;

      var getTime = function getTime() {
        var curr = new Date();
        _this.currTimeDiv.innerHTML = curr;
...
/***/ "./src/scripts/components/register-alarm.js":
/*!**************************************************!*\
  !*** ./src/scripts/components/register-alarm.js ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ RegisterAlarm; }
/* harmony export */ });
/* harmony import */ var flatpickr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flatpickr */ "./node_modules/flatpickr/dist/esm/index.js");
/* harmony import */ var flatpickr_dist_l10n_ko_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flatpickr/dist/l10n/ko.js */ "./node_modules/flatpickr/dist/l10n/ko.js");
/* harmony import */ var flatpickr_dist_l10n_ko_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(flatpickr_dist_l10n_ko_js__WEBPACK_IMPORTED_MODULE_1__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var RegisterAlarm = /*#__PURE__*/function () {
  function RegisterAlarm(_ref) {
    var $root = _ref.$root,
        onAdd = _ref.onAdd;

    _classCallCheck(this, RegisterAlarm);
  ...
  _createClass(RegisterAlarm, [{
    ...
    value: function init() {
      ...
      var frag = document.createDocumentFragment();
      var title = document.createElement("h2");
      var titleText = document.createTextNode("알람 등록");
      title.appendChild(titleText);
      frag.appendChild(title);
      var clockModeText = document.createTextNode("시계모드: ");
      ...
      var datePickText = document.createTextNode("시간설정: ");
      this.datePick = document.createElement("input");
      this.datePick.className = "dateSelector";
      this.datePick.placeholder = "연도. 월. 일.";
      flatpickr__WEBPACK_IMPORTED_MODULE_0__.default.localize(flatpickr_dist_l10n_ko_js__WEBPACK_IMPORTED_MODULE_1__.Korean);
      (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__.default)(this.datePick, {
        dateFormat: "Y.m.d.",
        minDate: "today"
      });
      ...
      frag.appendChild(document.createElement("br"));
      var alarmModeText = document.createTextNode("알람모드: ");
      ...
      (0,flatpickr__WEBPACK_IMPORTED_MODULE_0__.default)(this.timePick, {
        enableTime: true,
        noCalendar: true,
        dateFormat: "H:i",
        time_24hr: true
      ...
      frag.appendChild(document.createElement("br"));
      var contentText = document.createTextNode("내용: ");
      ...
      frag.appendChild(document.createElement("br"));
      var addBtnText = document.createTextNode("내용추가");
    ...
    key: "addOption",
    value: function addOption(modeList) {
      var frag = document.createDocumentFragment();
      modeList.forEach(function (mode) {
        var optionBox = document.createElement("option");
        var textNode = document.createTextNode(mode);
    ...
    key: "getMode",
    value: function getMode(time, alarm) {
      switch (time) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_app_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/app.js */ "./src/scripts/components/app.js");

window.addEventListener("DOMContentLoaded", function () {
  var app = new _components_app_js__WEBPACK_IMPORTED_MODULE_0__.default(document.querySelector(".app"));
});
